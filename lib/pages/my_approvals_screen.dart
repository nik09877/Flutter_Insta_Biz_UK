      ...
      body: userAccounts != null
          ? Form(
              ...
              child: Column(
                ...
                children: [
                  SizedBox(
                    width: isMobile(context)?MediaQuery.of(context).size.width:MediaQuery.of(context).size.width*0.40,
                      ...
                      items: userAccounts?.map<DropdownMenuItem>((acc) {
                        ...
                        return DropdownMenuItem(
                          ...
                          child: Row(
                            ...
                            children: [
                              SizedBox(
                                  width: isMobile(context)?250:100,
                                  child: Text(
                                    value,
                  ...
                  const Spacer(),
                   Row(
                      ...
                      children: [
                          SizedBox(
                            width:isMobile(context)?MediaQuery.of(context).size.width*0.45:MediaQuery.of(context).size.width*0.20,
